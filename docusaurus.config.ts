...
const config: Config = {
  ...
  url: 'https://tayyaba-ramzan.github.io',
  ...
  baseUrl: '/Hackathon-I-AI-Humanoid-Robotics/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'tayyaba-ramzan', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        {
          ...
          items: [
            {
              html: `
                <a href="https://github.com/tayyaba-ramzan" target="_blank" rel="noopener noreferrer" class="footer__link-item" aria-label="GitHub">
            ...
            {
              html: `
                <a href="https://www.linkedin.com/in/tayyabaRamzan/" target="_blank" rel="noopener noreferrer" class="footer__link-item" aria-label="LinkedIn">
            ...
            {
              html: `
                <a href="mailto:tayyabaramzan.pak@gmail.com" target="_blank" rel="noopener noreferrer" class="footer__link-item" aria-label="Email">
      ...
      copyright: `Made by : Tayyaba Ramzan`,
    },
